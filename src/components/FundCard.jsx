...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick, category, name }) => {
  const remainingDays = daysLeft(deadline);
  
  return (
    <div className="sm:w-[388px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
